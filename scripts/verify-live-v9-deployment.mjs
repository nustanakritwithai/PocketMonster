...
export const PAGES_LIVE_SMOKE_FILES = Object.freeze([
  ...
  'pirate-fruit-offline/assets/index-DTCSihWI.js',
  ...
  'pirate-fruit-offline/assets/SunscarDesertIsland-07feLGsv.js',
  'pirate-fruit-offline/assets/TempestSkyIsland-BgY3vPZ9.js',
