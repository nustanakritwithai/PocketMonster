...
export const EXPECTED_PIRATE_SOURCE_COMMIT = 'e952c03b005ac5b0527ae0f096a80f6211f56e8d';
export const EXPECTED_PIRATE_ARTIFACT_SHA256 = '927cd7ef64c7667b81effe12e03102ec3db88751196d88335d09fbdb87b47759';
...
export const PAGES_LIVE_SMOKE_FILES = Object.freeze([
  ...
  'pirate-fruit-offline/assets/index-DhkQluXj.js',
  'pirate-fruit-offline/assets/AzureFrostIsland-CWtnbcj4.js',
  'pirate-fruit-offline/assets/EmberVolcanoIsland-DrepV_1E.js',
  'pirate-fruit-offline/assets/MistJungleIsland-B_VCuzdr.js',
  'pirate-fruit-offline/assets/SunscarDesertIsland-rXqnhcxw.js',
  'pirate-fruit-offline/assets/TempestSkyIsland-uF-mm9Kb.js',
...
async function verifyPages(options, runtimeConfig) {
  ...
  if (!bodies.get('pirate-fruit-offline/index.html').includes('pocket-bootstrap.mjs?v=8')) {
