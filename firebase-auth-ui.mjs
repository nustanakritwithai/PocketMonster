...
const notifyAuthIntent = method => window.dispatchEvent(new CustomEvent('pocketmonster:auth-intent', { detail: { method } }));

function bindAuthUi() {
  document.getElementById('guestLoginBtn')?.addEventListener('click', async () => {
    notifyAuthIntent('guest');
  ...
  document.getElementById('loginForm')?.addEventListener('submit', async event => {
    event.preventDefault(); notifyAuthIntent('password'); const button = document.getElementById('loginAccountBtn'); button.disabled = true;
  ...
  document.getElementById('registerForm')?.addEventListener('submit', async event => {
    event.preventDefault(); notifyAuthIntent('register'); const button = document.getElementById('registerAccountBtn'); button.disabled = true;
