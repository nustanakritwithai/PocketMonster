...
import { syncPirateFruitControlHud } from './pirate-fruit-control-hud-v900.mjs?v=9';
...
export const PIRATE_FRUIT_OFFLINE_ENTRY = new URL('./pirate-fruit-offline/index.html?v=929', import.meta.url).href;
