...
import { createPirateNpcNameParentProxy } from './pirate-npc-name-interaction-v900.mjs?v=8';
...
export const PIRATE_FRUIT_OFFLINE_ENTRY = new URL('./pirate-fruit-offline/index.html?v=921', import.meta.url).href;
