...
const runtimeMutants=[
  ...
  ['skip stage navigation refresh after Boss clear',gameSource.replace('runBestEffortCombatPresentation(()=>{renderStageSelect();renderStageReward({definition,first,rewards,elapsed});});','runBestEffortCombatPresentation(()=>{renderStageReward({definition,first,rewards,elapsed});});'),htmlSource],
