...
assert.match(activeHtml, /entry\-preload\-v900\.mjs\?v=1004/, 'active entry bypasses cached bootstrap modules');
assert.match(activeEntry, /prepareLaunch/);
assert.match(activeEntry, /applyPendingPatch/);
assert.match(activeEntry, /online\-world\-shell\-v900\.mjs\?v=95/);
