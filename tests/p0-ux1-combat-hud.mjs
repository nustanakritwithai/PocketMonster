...
assert.match(js, /visibleCombatReason\(skillStatusLocked\?'คู่หูติดสถานะควบคุม • ใช้สกิลไม่ได้':presentation\.actionReason\)/, 'held skill reason and live control lock are what the chip renders');
