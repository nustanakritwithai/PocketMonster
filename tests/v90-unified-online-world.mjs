...
const parentShellIndex = entry.indexOf("await import('./online-world-shell-v900.mjs?v=15')");
...
assert.match(shell, /searchParams\.set\('shellRevision', '13'\)/, 'persistent shell cache-busts the changed scene HTML');
