...
assert.match(indexHtml, /entry-preload-v900\.mjs\?v=973/, 'active HTML cache-busts the unified ship-control entry');
assert.match(indexHtml, /style-v900\.css\?v=970/, 'active HTML cache-busts the helm placement beside chat');
assert.match(sceneHtml, /style-v900\.css\?v=970/, 'hosted scene cache-busts the same V9 stylesheet');
...
assert.match(shell, /combined-worlds-v900\.mjs\?v=955/, 'persistent shell cache-busts the changed world catalog');
assert.match(shell, /searchParams\.set\('shellRevision', '68'\)/, 'persistent shell cache-busts the changed scene HTML');
assert.match(worlds, /combined-worlds-v900\.mjs\?v=955/, 'scene router cache-busts the changed world catalog');
...
const childWorldImportIndex = sceneEntry.indexOf("await import('./worlds-v900.mjs?v=961')");
