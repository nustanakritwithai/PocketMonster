...
assert.match(indexHtml, /entry-preload-v900\.mjs\?v=980/, 'active HTML cache-busts the unified ship-control entry');
...
const childWorldImportIndex = sceneEntry.indexOf("await import('./worlds-v900.mjs?v=964')");
