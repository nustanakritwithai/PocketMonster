...
assert.match(indexHtml, /style-v900\.css\?v=971/, 'active HTML cache-busts the helm placement beside chat');
assert.match(sceneHtml, /style-v900\.css\?v=971/, 'hosted scene cache-busts the same V9 stylesheet');
