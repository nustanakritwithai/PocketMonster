...
const parentShellIndex = entry.indexOf("await import('./online-world-shell-v900.mjs?v=20')");
...
assert.match(shell, /searchParams\.set\('shellRevision', '26'\)/, 'persistent shell cache-busts the changed scene HTML');
