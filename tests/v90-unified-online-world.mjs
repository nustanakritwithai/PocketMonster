...
assert.match(indexHtml, /style-v900\.css\?v=920/, 'active HTML cache-busts the Pirate-primary presentation and persistent shell layout');
...
const parentShellIndex = entry.indexOf("await import('./online-world-shell-v900.mjs?v=16')");
