...
assert.match(indexHtml, /style-v900\.css\?v=972/, 'active HTML cache-busts the helm placement beside chat');
assert.match(sceneHtml, /style-v900\.css\?v=972/, 'hosted scene cache-busts the same V9 stylesheet');
