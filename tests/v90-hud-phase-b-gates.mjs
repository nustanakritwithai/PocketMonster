...
assert.match(index, /style-v900\.css\?v=928/);
assert.match(scene, /style-v900\.css\?v=928/);
...
assert.match(css, /#pirateUnifiedControls\{[^}]*--arc-r:82px/, 'combat cluster stays an arc');
