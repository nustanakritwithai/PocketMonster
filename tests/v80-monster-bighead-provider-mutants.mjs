...
assert.doesNotMatch(js, /createBigheadMonsterProvider/, 'mutant 1: gameplay must not register the monster provider in Phase 1');
...
assert.doesNotMatch(js, /assets\.spawn\('monster\./, 'mutant 7: live monsters still go through makeSpeciesMesh');
