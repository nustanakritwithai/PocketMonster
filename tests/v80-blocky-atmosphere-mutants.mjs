...
assert.match(ground, /scene\.fog\.near=zone==='cave'\?15:zone==='frozen-pass'\?18:zone==='rocky-canyon'\?24:zone==='sky-ruins'\?22:zone==='poison-marsh'\?18:zone==='dream-shrine'\?20:zone==='haunted-woods'\?14:zone==='shadow-city'\?16:30/, 'mutant 5: stage fog near distances stay intentional');
assert.match(ground, /scene\.fog\.far=zone==='cave'\?50:zone==='frozen-pass'\?62:zone==='rocky-canyon'\?68:zone==='sky-ruins'\?80:zone==='poison-marsh'\?58:zone==='dream-shrine'\?64:zone==='haunted-woods'\?48:zone==='shadow-city'\?60:76/, 'mutant 6: stage fog far distances stay intentional');
...
assert.match(js, /sphereGeometry\(\.16\*scale,12,10\)/, 'mutant 23: monster shine stays a sphere');
