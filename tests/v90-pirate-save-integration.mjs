...
assert.match(entry, /online-world-shell-v900\.mjs\?v=78/, 'top-level entry cache-busts the unified ship-control shell');
assert.match(sceneHtml, /scene-entry-v900\.mjs\?v=67/, 'scene HTML cache-busts the unified Pirate ship-control bridge');
assert.match(sceneHtml, /style-v900\.css\?v=980/, 'scene HTML cache-busts the helm placement beside chat');
