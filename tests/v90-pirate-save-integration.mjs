...
assert.match(boot, /index\.html\?v=918/, 'parent cache-busts the Pirate child HTML without the circular minimap');
assert.match(combined, /boot-pirate-fruit-v900\.mjs\?v=926/, 'world catalog keeps the current Pirate boot module revision');
...
assert.match(offlineHtml, /pocket-presentation\.mjs\?v=9/, 'offline HTML cache-busts presentation integration after child minimap retirement');
