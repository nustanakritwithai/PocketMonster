...
assert.match(combined, /boot-pirate-fruit-v900\.mjs\?v=916/, 'world catalog cache-busts the sandbox/save boot beyond latest main');
...
assert.match(sceneHtml, /scene-entry-v900\.mjs\?v=13/, 'scene HTML cache-busts pagehide capability revocation beyond latest main');
