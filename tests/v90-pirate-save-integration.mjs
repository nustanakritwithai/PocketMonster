...
assert.match(sceneHtml, /scene-entry-v900\.mjs\?v=65/, 'scene HTML cache-busts the unified Pirate ship-control bridge');
assert.match(sceneHtml, /style-v900\.css\?v=976/, 'scene HTML cache-busts the helm placement beside chat');
