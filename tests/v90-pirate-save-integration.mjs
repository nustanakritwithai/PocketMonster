...
assert.match(sceneHtml, /scene-entry-v900\.mjs\?v=25/, 'scene HTML cache-busts the shared transport dependency chain and fullscreen ownership');
assert.match(sceneHtml, /style-v900\.css\?v=926/, 'scene HTML cache-busts the persistent fullscreen control layout');
