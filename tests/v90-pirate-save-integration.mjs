...
assert.match(entry, /online-world-shell-v900\.mjs\?v=63/, 'top-level entry cache-busts the unified ship-control shell');
assert.match(sceneHtml, /scene-entry-v900\.mjs\?v=59/, 'scene HTML cache-busts the unified Pirate ship-control bridge');
