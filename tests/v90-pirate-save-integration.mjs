...
assert.match(entry, /online-world-shell-v900\.mjs\?v=34/, 'top-level entry cache-busts the production Combat transport and BFCache restore behavior');
...
assert.match(sceneHtml, /style-v900\.css\?v=947/, 'scene HTML cache-busts the persistent fullscreen control layout');
