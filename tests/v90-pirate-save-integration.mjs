...
assert.match(entry, /online-world-shell-v900\.mjs\?v=15/, 'top-level entry cache-busts BFCache restore behavior beyond latest main');
assert.match(sceneHtml, /scene-entry-v900\.mjs\?v=16/, 'scene HTML cache-busts scene-entry fullscreen ownership beyond latest main');
