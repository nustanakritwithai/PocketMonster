...
assert.match(offlineHtml, /src="\.\/pocket-bootstrap\.mjs\?v=7"/, 'offline HTML loads the save-aware bootstrap');
...
assert.match(combined, /boot-pirate-fruit-v900.mjs\?v=969/, 'world catalog keeps the current Pirate boot module revision');
assert.match(entry, /online\-world\-shell\-v900\.mjs\?v=90/, 'top-level entry cache-busts the unified ship-control shell');
assert.match(sceneHtml, /scene-entry-v900\.mjs\?v=75/, 'scene HTML cache-busts the unified Pirate ship-control bridge');
