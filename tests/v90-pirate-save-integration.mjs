...
assert.match(combined, /boot-pirate-fruit-v900.mjs\?v=961/, 'world catalog keeps the current Pirate boot module revision');
assert.match(entry, /online-world-shell-v900\.mjs\?v=73/, 'top-level entry cache-busts the unified ship-control shell');
assert.match(sceneHtml, /scene-entry-v900\.mjs\?v=66/, 'scene HTML cache-busts the unified Pirate ship-control bridge');
