...
assert.match(combined, /boot-pirate-fruit-v900.mjs\?v=962/, 'world catalog keeps the current Pirate boot module revision');
assert.match(entry, /online-world-shell-v900\.mjs\?v=76/, 'top-level entry cache-busts the unified ship-control shell');
assert.match(sceneHtml, /scene-entry-v900\.mjs\?v=67/, 'scene HTML cache-busts the unified Pirate ship-control bridge');
