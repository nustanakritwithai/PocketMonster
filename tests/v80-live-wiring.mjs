...
assert.ok(html.includes('entry-preload-v900.mjs') && preload.includes("await import('./game-v800.js?v=814')"), 'authenticated legacy preload loads the current v800 runtime');
