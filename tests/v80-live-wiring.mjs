...
assert.ok(html.includes('entry-preload-v900.mjs') && preload.includes("await import('./game-v800.js?v=835')"), 'authenticated legacy preload loads the current v800 runtime');
assert.ok(html.includes('style-v800.css?v=818'), 'active HTML loads the current v800 stylesheet');
