...
assert.match(html, /entry-preload-v900\.mjs\?v=981/, 'active V9 entry must cache-bust the unified Pirate ship-control preload chain');
...
assert.match(preload, /await import\('\.\/game-v800\.js\?v=819'\)/, 'preload must import game only after launch gate');
