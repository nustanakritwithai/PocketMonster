...
assert.match(js, /circleGeometry\(radius,36\)/, 'ground decals stay circular until Phase 4');
assert.match(js, /function spawnRingPulse\([\s\S]*?torusGeometry/, 'ring pulses stay toruses until Phase 4');
