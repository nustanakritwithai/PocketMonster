...
const liveMutants = [
  ...
  ['drop reviewed E1 coverage gate', source => replaceOnce(source, 'if(!canExecuteE1SkillEffect(command.skillId))return false;', 'if(false)return false;')],
  ...
  ['silently broaden deferred manual effects', source => replaceOnce(source, 'return validateE1SkillEffectRequest(canonicalE1SkillEffectRequest(a,move,command,materialized)).ok;', 'return true;')],
