...
assert.match(worldCatalog, /boot-pirate-fruit-v900\.mjs\?v=946/);
...
const pirateBundle = fs.readFileSync(new URL('../pirate-fruit-offline/assets/index-PYS02ZJs.js', import.meta.url), 'utf8');
assert.match(
  pirateBundle,
