...
assert.match(worldCatalog, /boot-pirate-fruit-v900\.mjs\?v=938/);
...
assert.match(childEntry, /pocket-presentation\.mjs\?v=20/, 'Pirate child HTML cache-busts presentation after the same-origin talk-chip fix');
