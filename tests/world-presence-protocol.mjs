...
assert.match(chat, /createPresenceRouteDiagnostics.*world-presence-protocol\.mjs\?v=8/, 'chat runtime owns local route diagnostics');
...
assert.match(bridge, /from '\.\/world-presence-protocol\.mjs\?v=8'/, 'online bridge imports the shared protocol');
