...
assert.match(js,/grassMeadowNormal:\{battleExpBase:8,battleExpPerLevel:4,captureExp:8,respawnMs:12000\}/,'Grass Meadow normal reward/respawn profile exists');
...
assert.match(js,/resolveWorkbookCapture\(input\)/,'Grass Meadow uses the canonical workbook capture resolver');
assert.doesNotMatch(js,/captureBonus:\.05|sp\.capture\+captureBonus/,'legacy scene capture bonus cannot shadow CAP_v1.0');
