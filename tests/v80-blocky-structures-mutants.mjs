...
assert.match(js, /circleGeometry\(radius,36\)/, 'mutant 11: Phase 3 does not convert ground decals');
assert.match(js, /function spawnRingPulse\([\s\S]*?torusGeometry/, 'mutant 12: Phase 3 does not convert ring pulses');
assert.match(js, /new THREE\.Fog\(0x65c9f5,30,76\)/, 'mutant 13: fog near/far stay until Phase 5');
