...
pagesFiles.set('pirate-fruit-offline/index.html', '<script type="module" src="./pocket-bootstrap.mjs?v=11"></script>');
pagesFiles.set('pirate-fruit-offline/pocket-bootstrap.mjs', "import { installPirateSaveSandbox } from '../pirate-save-bridge-v900.mjs?v=3';\nawait installPirateSaveSandbox();\nawait import('./assets/index-C0el93GC.js');\n");
const manifest = {
