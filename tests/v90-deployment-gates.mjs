...
pagesFiles.set('pirate-fruit-offline/index.html', '<script type="module" src="./pocket-bootstrap.mjs?v=8"></script>');
pagesFiles.set('pirate-fruit-offline/pocket-bootstrap.mjs', "import { installPirateSaveSandbox } from '../pirate-save-bridge-v900.mjs?v=2';\nawait installPirateSaveSandbox();\nawait import('./assets/index-DhkQluXj.js');\n");
const manifest = {
