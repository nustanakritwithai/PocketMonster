...
assert.match(presentation, /pirate-fruit-control-hud-v900\.mjs\?v=20/, 'presentation cache-busts trade-shop HUD policy');
...
assert.match(html, /style-v900\.css\?v=972/, 'active HTML cache-busts after removing merchant portrait CSS');
