...
const captureSuccess = extractFn('finishCaptureSuccess');
...
assert.match(captureSuccess, /spawnGroundDecal\(wildTypes\(w\)\[0\],cs\.pos\.clone\(\)/,
  'mutant 8: capture stamps a ground decal from its durable pre-disposal position snapshot');
