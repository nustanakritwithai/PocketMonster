...
assert.match(preload, /chat-runtime\.mjs\?v=8\.4\.0-original-world-1/, 'chat layout change must cache-bust');
assert.match(preload, /chat-runtime\.mjs\?v=8\.4\.0-original-world-1[\s\S]*game\-v800\.js\?v=839/, 'chat must bind before game overlays');
