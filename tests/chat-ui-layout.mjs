...
assert.match(preload, /chat-runtime\.mjs\?v=8\.4\.0-world-presence-hardened/, 'chat layout change must cache-bust');
assert.match(preload, /chat-runtime\.mjs\?v=8\.4\.0-world-presence-hardened[\s\S]*game-v800\.js\?v=815/, 'chat must bind before game overlays');
