...
assert.match(preload, /chat-runtime\.mjs\?v=8\.4\.0-presence-protocol-owner/, 'chat layout change must cache-bust');
assert.match(preload, /chat-runtime\.mjs\?v=8\.4\.0-presence-protocol-owner-2[\s\S]*game-v800\.js\?v=819/, 'chat must bind before game overlays');
