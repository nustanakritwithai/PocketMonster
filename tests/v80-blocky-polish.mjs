...
assert.match(extractFn('setZoneGround'), /scene\.fog\.near=zone==='cave'\?15:zone==='frozen-pass'\?18:zone==='rocky-canyon'\?24:30/, 'P5 cave, Frozen Pass, and Rocky Canyon fog remain readable');
