...
assert.match(liveHtml, /id="controlPanelSwitcher"/, 'mutant 17: live V9 includes the control-panel switcher');
...
assert.match(cssV900, /body\[data-combined-world\] #controlPanelSwitcher\{display:flex/, 'mutant 21c: combined worlds reveal the panel switcher');
...
assert.match(boot, /game-v800\.js\?v=826&animalControl=pirate-fruit/, 'mutant 23d: throw boots a dedicated animal-control instance');
