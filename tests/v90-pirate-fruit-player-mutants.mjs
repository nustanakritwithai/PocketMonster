...
assert.equal(worldById('pocket-monster').runtime, './game-v800.js?v=835', 'mutant 0e: original game runtime is game-v800.js');
...
assert.match(boot, /game\-v800\.js\?v=835&animalControl=pirate-fruit/, 'mutant 23d: throw boots a dedicated animal-control instance');
