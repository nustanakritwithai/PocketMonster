...
assert.equal(worldById('pirate-fruit').runtime, './boot-pirate-fruit-v900.mjs?v=970', 'mutant 0e2: pirate world still boots through the cache-busted pirate boot module');
...
assert.match(shellJs, /chat-runtime\.mjs\?v=8\.4\.0-central-hp-1/, 'mutant 27: persistent V9 shell loads one presence-aware Pocket chat transport');
