...
assert.equal(worldById('pocket-monster').runtime, './game-v800.js?v=819', 'mutant 0e: original game runtime is game-v800.js');
assert.equal(worldById('pirate-fruit').runtime, './boot-pirate-fruit-v900.mjs?v=913', 'mutant 0e2: pirate world still boots through the pirate boot module');
...
assert.match(boot, /game-v800\.js\?v=819&animalControl=pirate-fruit/, 'mutant 23d: throw boots a dedicated animal-control instance');
...
assert.match(boot, /ui: 'v900-parent-unified'/, 'mutant 24b2: pirate boot uses the parent V9 HUD');
