...
assert.equal(worldById('pirate-fruit').runtime, './boot-pirate-fruit-v900.mjs?v=949', 'mutant 0e2: pirate world still boots through the cache-busted pirate boot module');
