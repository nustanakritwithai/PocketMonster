...
assert.match(preload, /chat-runtime\.mjs\?v=8\.4\.0-world-presence-hardened/, 'live preload cache-busts the top-right chat');
assert.match(preload, /chat-runtime\.mjs\?v=8\.4\.0-world-presence-hardened[\s\S]*game-v800\.js\?v=815/, 'legacy preload binds chat before game overlays');
