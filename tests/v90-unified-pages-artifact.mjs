...
assert.match(index, /entry-preload-v900.mjs\?v=973/);
assert.match(index, /style-v900\.css\?v=971/);
...
assert.match(scene, /style-v900\.css\?v=971/, 'scene entry loads the same HUD stylesheet revision as the parent');
