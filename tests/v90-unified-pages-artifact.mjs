...
assert.match(index, /entry-preload-v900.mjs\?v=953/);
assert.match(index, /style-v900\.css\?v=961/);
...
assert.match(scene, /style-v900\.css\?v=961/, 'scene entry loads the same HUD stylesheet revision as the parent');
