...
assert.match(index, /entry-preload-v900.mjs\?v=948/);
assert.match(index, /style-v900\.css\?v=958/);
...
assert.match(scene, /style-v900\.css\?v=958/, 'scene entry loads the same HUD stylesheet revision as the parent');
