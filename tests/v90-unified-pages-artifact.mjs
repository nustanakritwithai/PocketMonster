...
assert.match(index, /entry-preload-v900.mjs\?v=978/);
assert.match(index, /style-v900\.css\?v=975/);
...
assert.match(scene, /style-v900\.css\?v=975/, 'scene entry loads the same HUD stylesheet revision as the parent');
