...
assert.match(index, /entry-preload-v900.mjs\?v=961/);
assert.match(index, /style-v900\.css\?v=965/);
...
assert.match(scene, /style-v900\.css\?v=965/, 'scene entry loads the same HUD stylesheet revision as the parent');
