...
assert.match(index, /entry-preload-v900\.mjs\?v=933/);
assert.match(index, /style-v900\.css\?v=935/);
...
assert.match(scene, /style-v900\.css\?v=935/, 'scene entry loads the same HUD stylesheet revision as the parent');
