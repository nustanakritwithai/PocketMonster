...
assert.match(index, /entry-preload-v900.mjs\?v=970/);
assert.match(index, /style-v900\.css\?v=968/);
...
assert.match(scene, /style-v900\.css\?v=968/, 'scene entry loads the same HUD stylesheet revision as the parent');
