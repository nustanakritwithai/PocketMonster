...
assert.match(index, /entry-preload-v900.mjs\?v=945/);
assert.match(index, /style-v900\.css\?v=949/);
...
assert.match(scene, /style-v900\.css\?v=949/, 'scene entry loads the same HUD stylesheet revision as the parent');
