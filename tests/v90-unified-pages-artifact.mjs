...
assert.match(index, /entry-preload-v900.mjs\?v=946/);
assert.match(index, /style-v900\.css\?v=950/);
...
assert.match(scene, /style-v900\.css\?v=950/, 'scene entry loads the same HUD stylesheet revision as the parent');
