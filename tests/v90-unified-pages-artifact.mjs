...
assert.match(index, /entry-preload-v900.mjs\?v=968/);
assert.match(index, /style-v900\.css\?v=967/);
...
assert.match(scene, /style-v900\.css\?v=967/, 'scene entry loads the same HUD stylesheet revision as the parent');
