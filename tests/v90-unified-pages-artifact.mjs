...
assert.match(index, /entry-preload-v900\.mjs\?v=934/);
assert.match(index, /style-v900\.css\?v=936/);
...
assert.match(scene, /style-v900\.css\?v=936/, 'scene entry loads the same HUD stylesheet revision as the parent');
