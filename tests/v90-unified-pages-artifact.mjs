...
assert.match(index, /entry-preload-v900.mjs\?v=956/);
assert.match(index, /style-v900\.css\?v=962/);
...
assert.match(scene, /style-v900\.css\?v=962/, 'scene entry loads the same HUD stylesheet revision as the parent');
