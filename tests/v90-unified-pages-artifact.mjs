...
assert.match(index, /entry-preload-v900.mjs\?v=986/);
assert.match(index, /style-v900\.css\?v=979/);
...
assert.match(scene, /style-v900\.css\?v=979/, 'scene entry loads the same HUD stylesheet revision as the parent');
