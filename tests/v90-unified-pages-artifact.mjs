...
assert.match(index, /entry-preload-v900\.mjs\?v=928/);
assert.match(index, /style-v900\.css\?v=930/);
const scene = fs.readFileSync(path.join(output, 'scene-v900.html'), 'utf8');
assert.match(scene, /style-v900\.css\?v=930/, 'scene entry loads the same HUD stylesheet revision as the parent');
