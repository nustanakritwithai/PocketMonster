...
assert.match(index, /entry-preload-v900.mjs\?v=951/);
assert.match(index, /style-v900\.css\?v=959/);
...
assert.match(scene, /style-v900\.css\?v=959/, 'scene entry loads the same HUD stylesheet revision as the parent');
