...
assert.match(index, /entry-preload-v900.mjs\?v=949/);
assert.match(index, /style-v900\.css\?v=957/);
...
assert.match(scene, /style-v900\.css\?v=957/, 'scene entry loads the same HUD stylesheet revision as the parent');
