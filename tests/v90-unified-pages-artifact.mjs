...
assert.match(index, /entry-preload-v900.mjs\?v=944/);
assert.match(index, /style-v900\.css\?v=948/);
...
assert.match(scene, /style-v900\.css\?v=948/, 'scene entry loads the same HUD stylesheet revision as the parent');
