...
assert.match(index, /entry-preload-v900.mjs\?v=987/);
assert.match(index, /style-v900\.css\?v=980/);
...
assert.match(scene, /style-v900\.css\?v=980/, 'scene entry loads the same HUD stylesheet revision as the parent');
