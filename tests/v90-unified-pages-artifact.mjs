...
assert.match(index, /entry-preload-v900.mjs\?v=960/);
assert.match(index, /style-v900\.css\?v=964/);
...
assert.match(scene, /style-v900\.css\?v=964/, 'scene entry loads the same HUD stylesheet revision as the parent');
