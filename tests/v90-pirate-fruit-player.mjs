...
assert.match(preload, /game-v800\.js\?v=816/, 'legacy V8.4 preload remains available for v800.html');
...
assert.equal(worldById('pocket-monster').runtime, './game-v800.js?v=824');
...
assert.match(boot, /game-v800\.js\?v=824&animalControl=pirate-fruit/, 'throw runtime is a dedicated pirate animal-control instance');
