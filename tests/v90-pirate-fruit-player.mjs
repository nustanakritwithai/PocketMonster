...
assert.equal(DEFAULT_COMBINED_WORLD, 'pocket-monster');
assert.equal(resolveCombinedWorld({ href: 'https://example.test/v900.html' }), 'pocket-monster');
...
assert.match(worldsJs, /defaultWorld: DEFAULT_COMBINED_WORLD/, 'combined channel starts in Pocket Monster');
