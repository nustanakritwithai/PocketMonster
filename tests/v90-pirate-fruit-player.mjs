...
assert.match(preload, /game-v800\.js\?v=817/, 'legacy V8.4 preload remains available for v800.html');
...
assert.match(preloadV900, /online-world-shell-v900\.mjs\?v=15/, 'V9 preload cache-busts the persistent 3-world shell after login');
...
assert.equal(worldById('pocket-monster').runtime, './game-v800.js?v=825');
...
assert.match(boot, /game-v800\.js\?v=825&animalControl=pirate-fruit/, 'throw runtime is a dedicated pirate animal-control instance');
