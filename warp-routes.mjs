...
export const WARP_ROUTES=Object.freeze([
  ...
  {id:'steel-to-dragon',from:'steel-factory',to:'dragon-crater',label:'Dragon Crater',position:[20,0],spawn:[-19,0,0],kind:'forward'},
  {id:'dragon-to-steel',from:'dragon-crater',to:'steel-factory',label:'Steel Factory',position:[-20,0],spawn:[19,0,0],kind:'return'},
  {id:'dragon-to-fairy',from:'dragon-crater',to:'fairy-garden',label:'Fairy Garden',position:[20,0],spawn:[-19,0,0],kind:'forward'},
  {id:'fairy-to-dragon',from:'fairy-garden',to:'dragon-crater',label:'Dragon Crater',position:[-20,0],spawn:[19,0,0],kind:'return'},
  {id:'fairy-to-combat',from:'fairy-garden',to:'combat-colosseum',label:'Combat Colosseum',position:[20,0],spawn:[-19,0,0],kind:'forward'},
  {id:'combat-to-fairy',from:'combat-colosseum',to:'fairy-garden',label:'Fairy Garden',position:[-20,0],spawn:[19,0,0],kind:'return'},
  {id:'combat-to-normal',from:'combat-colosseum',to:'normal-wildlands',label:'Normal Wildlands',position:[20,0],spawn:[-19,0,0],kind:'forward'},
  {id:'normal-to-combat',from:'normal-wildlands',to:'combat-colosseum',label:'Combat Colosseum',position:[-20,0],spawn:[19,0,0],kind:'return'},
  {id:'normal-to-hub',from:'normal-wildlands',to:'hub',label:'Ranch Hub',position:[0,-19],spawn:[0,0,-7],kind:'return'},
