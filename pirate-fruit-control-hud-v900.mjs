...
export const PIRATE_FRUIT_INVENTORY_MESSAGE = 'pocketmonster:pirate-inventory-v1';
...
html[data-pirate-hud="pirate-primary-parent"] .trade-shop-root {
...
html[data-pirate-hud="pirate-primary-parent"] .trade-shop {
