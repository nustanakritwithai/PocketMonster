...
import { buildWorldPosFrame, createPresenceRouteDiagnostics, currentSelfPresenceId, filterRemotePlayers, worldSnapshotPayload } from './world-presence-protocol.mjs?v=7';
import { createVisualEventQueue } from './world-presence-protocol.mjs?v=7';
