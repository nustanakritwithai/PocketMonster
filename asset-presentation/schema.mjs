...
export const ALLOWED_PROVIDERS = Object.freeze(['procedural', 'gltf', 'legacy', 'pirate-fruit', 'studio-character']);
export const CHARACTER_ROLES = Object.freeze(['player', 'keeper', 'merchant', 'trainer', 'evolution', 'breeding']);
