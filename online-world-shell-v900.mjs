import { COMBINED_VERSION, resolveCombinedWorld, worldById } from './combined-worlds-v900.mjs?v=928';
...
import { createUnifiedMmorpgHud } from './unified-mmorpg-hud-v900.mjs?v=945';
...
function sceneUrl(worldId, panelId) {
  ...
  url.searchParams.set('shellRevision', '40');
  return url.href;
}
