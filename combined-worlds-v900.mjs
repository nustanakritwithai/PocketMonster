import { COMBINED_RUNTIME_VERSION } from './version-manifest.mjs';

/** V9 combined channel: 3 worlds. Control panels (human/throw) live in control-panels-v900.mjs. */
export const COMBINED_VERSION = COMBINED_RUNTIME_VERSION;
...
export const COMBINED_WORLDS = Object.freeze([
  ...
  Object.freeze({
    ...
    runtime: './boot-pirate-fruit-v900.mjs?v=953',
  }),
  Object.freeze({
    id: 'living-world',
    label: 'โลกกลาง',
